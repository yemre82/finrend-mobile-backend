...
class News(models.Model):
    ...
    featured_image = models.ImageField(
        blank=False, null=False, max_length=100, upload_to="news/images")
    ...
    content_image = models.ImageField(
        blank=False, null=False, max_length=100, upload_to="news/images/contentImage")
    content_image2 = models.ImageField(
        blank=False, null=False, max_length=100, upload_to="news/images/contentImage2")
...
class Activities(models.Model):
    ...
    image = models.ImageField(blank=False, null=False,
                              max_length=100, upload_to="activities")
    content = models.CharField(blank=False, null=False, max_length=1000)
...
class ActivitiesComment(models.Model):
    ...
    image = models.ImageField(blank=True, null=True,
                              max_length=100, upload_to="activities/comment")
    content = models.CharField(blank=False, null=False, max_length=1000)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
